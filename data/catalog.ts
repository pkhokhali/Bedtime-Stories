...
import { langtangWaterfallBeats } from '@/data/stories/langtang-waterfall';
import { lastLampThamelBeats } from '@/data/stories/last-lamp-thamel';
import { lettersRiverBeats } from '@/data/stories/letters-river';
import { littlePineSleepBeats } from '@/data/stories/little-pine-sleep';
import { midnightChiyaBeats } from '@/data/stories/midnight-chiya';
...
export const stories: Story[] = [
  ...
  },
  {
    ...
    accent: '#F4E6C8',
    stage: 'moon',
    coverImage: 'https://images.unsplash.com/photo-1532693322450-2cb5c511067d?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    title: { en: 'The Little Pine That Learned to Sleep', ne: 'सुत्न सिकेको सानो सल्ला' },
    subtitle: { en: 'A whisper in the Himalayan breeze.', ne: 'हिमाली मन्द हावाको साउती।' },
    theme: { en: 'Even the tallest trees rest at night', ne: 'अग्ला रुखहरू पनि राति विश्राम गर्छन्' },
    beats: littlePineSleepBeats,
  },
  {
    id: 'clever-rabbit',
    category: 'roots',
    ...
    accent: '#E8A04A',
    stage: 'forest',
    coverImage: 'https://images.unsplash.com/photo-1589656966895-2f33e7653819?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    accent: '#C4783A',
    stage: 'courtyard',
    coverImage: 'https://images.unsplash.com/photo-1582650625119-3a31f8418b7d?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    title: { en: 'The Secret Waterfall of Langtang', ne: 'लाङटाङको गुप्त झरना' },
    subtitle: { en: 'A hidden wonder in the pine forest.', ne: 'सल्लाको जङ्गलभित्रको लुकेको आश्चर्य।' },
    theme: { en: 'Patience reveals the mountain’s hidden treasures', ne: 'धैर्यले हिमालको लुकेको खजाना देखाउँछ' },
    beats: langtangWaterfallBeats,
  },
  {
    id: 'dove-net',
    category: 'universal',
    ...
    accent: '#F4E6C8',
    stage: 'stars',
    coverImage: 'https://images.unsplash.com/photo-1552728089-57bdde30beb3?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    accent: '#7BA37A',
    stage: 'river',
    coverImage: 'https://images.unsplash.com/photo-1477959858617-67f30bc75b82?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    stage: 'hills',
    cast: 'none',
    coverImage: 'https://images.unsplash.com/photo-1516214104703-d870798883c5?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    stage: 'hills',
    cast: 'none',
    coverImage: 'https://images.unsplash.com/photo-1483921020237-2ff51e8e4b22?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    stage: 'lamp',
    cast: 'none',
    coverImage: 'https://images.unsplash.com/photo-1507842229451-9f01079ca4b5?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    subtitle: { en: 'A quiet courtyard, warm glass, and sleeping hills.', ne: 'शान्त चोक, न्यानो गिलास, र सुतेका डाँडाहरू।' },
    theme: { en: 'In late silence, even ordinary warmth becomes sacred', ne: 'मध्यरातको मौनतामा, साधारण न्यानोपन पनि पवित्र हुन्छ' },
    beats: midnightChiyaBeats,
  },
];
